...
class CorrelationVizSettingsDialog(tk.Toplevel):
    ...
    def _create_ui(self) -> None:
        ...
        self.thumbnail_width_var = tk.IntVar(
            value=self.config_manager.get("correlation_thumbnail_width", 60)
        )
...
class CorrelationVizRow(tk.Frame):
    ...
    def _create_widgets(self) -> None:
        ...
        initial_source = self.viz_config.get("source", self.default_source)
        ...
        self.column_var = tk.StringVar(value=self.viz_config.get("column", ""))
        ...
        self.type_var = tk.StringVar(value=self.viz_config.get("type", "bar"))
