...
CSS_STYLES: str = """        :root {
        ...
        * { box-sizing: border-box; }
        ...
        .group-strat { font-weight: 600; font-size: 14px; color: var(--ink); }
        ...
        /* All Issues tab */
        .all-issues-hole-header td {
            background: var(--card-bg, #f8fafc);
            border-top: 2px solid var(--accent, #0d5b88);
            padding: 8px 6px !important;
            font-size: 13px;
        }
        .all-issues-hole-count {
            font-weight: normal;
            color: var(--muted, #5d6672);
            font-size: 12px;
        }
        .section-badge {
            display: inline-block;
