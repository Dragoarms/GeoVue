...
class IntervalMerger:
    ...
    def get_merged_dataframe_for_qaqc(
        ...
        if merge_geology:
            # Auto-detect geology/logging sources. Snowflake SENS_GAB
            # SUMMARY_LOGGING_ASSAYS is the current preferred RC logging view;
            # exgeologyRC names are retained for legacy CSV/config flows.
            ...
            for src_name in [
                ...
                if src_name.lower() in [s.lower() for s in available]:
                    ...
                    if actual_name.lower() != primary_source.lower():
