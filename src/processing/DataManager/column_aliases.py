...
COLUMN_ALIASES: Dict[str, List[str]] = {
    ...
    "loi_1000_pct": ["loi_1000_pct", "loi1000", "loi_1000", "loi1000_pct", "loi_pct_1000", "loi1000_pct_best"],
    "loi_425_pct": ["loi_425_pct", "loi425", "loi_425", "loi425_pct", "loi_pct_425", "loi425_pct_best"],
    "loi_650_pct": ["loi_650_pct", "loi650", "loi_650", "loi650_pct", "loi_pct_650", "loi650_pct_best"],
    ...
    "zn_pct": ["zn_pct", "zn_pct_best", "zn%", "zn_percent", "zn", "zinc_pct"],
    "mno_pct": ["mno_pct", "mno_pct_best", "mno%", "mno_percent", "mno"],

    # === Additional assay elements (mafic indicators) ===
    "cr2o3_pct": ["cr2o3_pct", "cr2o3_pct_best", "cr2o3%", "cr2o3_percent", "cr2o3"],
    "nio_pct": ["nio_pct", "nio_pct_best", "nio%", "nio_percent", "nio"],
    ...
    "loggeddate": ["loggeddate", "logged_date", "logdate"],
    "holedepth": ["holedepth", "hole_depth", "eoh", "enddepth", "max_depth", "maxdepth", "total_depth"],

    # === Geological columns ===
    "lithology": ["lithology", "lith", "lith_code", "rock_type", "rocktype"],
    "strat": ["strat", "strat_code", "stratigraphy", "stratcode", "beststrat", "beststratres_samp"],
    ...
    # === Normative mineralogy (Snowflake NORMATIVE_MINERALOGY table) ===
    "norm_hematite": ["hematite", "norm_hematite", "he_norm"],
    "norm_goethite": ["goethite", "norm_goethite", "go_norm"],
    "norm_kaolinite": ["kaolinite", "norm_kaolinite", "ka_norm"],
    "norm_gibbsite": ["gibbsite", "norm_gibbsite", "gi_norm"],
    "norm_chert": ["chert", "norm_chert", "ch_norm"],
    "norm_pyrite": ["pyrite", "norm_pyrite", "py_norm"],
    "norm_apatite": ["apatite", "norm_apatite", "ap_norm"],
    "norm_phosphosiderite": ["phosphosiderite", "norm_phosphosiderite"],
    "norm_dolomite": ["dolomite", "norm_dolomite", "do_norm"],
    "norm_calcite": ["calcite", "norm_calcite", "ca_norm"],
    "norm_magnesite": ["magnesite", "norm_magnesite", "mg_norm"],
    "norm_manjorite": ["manjorite", "norm_manjorite"],
    "norm_manganese": ["manganese", "norm_manganese"],
    "norm_anatase": ["anatase", "norm_anatase", "an_norm"],
    "norm_kfeldsp": ["kfeldsp", "norm_kfeldsp", "kf_norm"],
    "norm_xsloi": ["xsloi", "norm_xsloi"],
