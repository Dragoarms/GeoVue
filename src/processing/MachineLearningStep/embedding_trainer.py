"""
Disabled stub for embedding_trainer.py

This script is temporarily disabled. All functions/classes are stubbed out to prevent execution
but allow imports and calls without breaking.
"""

# Comment out or remove all imports and code below this line if needed

def generate_embeddings(*args, **kwargs):
    print("generate_embeddings() is currently disabled.")
    return []

def plot_embeddings(*args, **kwargs):
    print("plot_embeddings() is currently disabled.")

class ImageTabularDataset:
    def __init__(self, *args, **kwargs):
        print("ImageTabularDataset is disabled.")

class EmbeddingModel:
    def __init__(self, *args, **kwargs):
        print("EmbeddingModel is disabled.")
    def eval(self):
        return self
