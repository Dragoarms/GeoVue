...
Uses transfer learning with pretrained CNNs for compartment classification.
"""
...
if TORCH_AVAILABLE:
    ...
    class WetDryClassifier(nn.Module):
        """
        Compartment classifier using transfer learning.
    ...
    def save_checkpoint(
        ...
        if class_names is not None:
            checkpoint["class_names"] = list(class_names)
