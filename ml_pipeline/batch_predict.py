...
Runs the compartment classifier on unlabeled images and outputs results.
"""
...
def run_batch_predictions(
    ...
    print("=" * 60)
    print("GeoVue ML Pipeline - Batch Compartment Classification")
    print("=" * 60)
    ...
    error_count = label_counts.pop("Error", 0)
