# GeoVue ML Pipeline - Compartment Classifier

An independent machine learning pipeline for training compartment classifiers using GeoVue's approved compartment images.
...
The pipeline looks for approved compartment images with class labels in the filename:
    ...
    └── Approved Compartment Images/
        └── [PROJECT]/
            └── [HOLE_ID]/
                ...
                ├── BA0001_CC_003_Empty.png   ← Labeled as "Empty"
                └── BA0001_CC_004.png         ← Unlabeled (skipped)
```

**Filename Pattern**: `{HoleID}_CC_{Depth}_{Dry|Wet|Empty}.png`
...
- Check that your compartment images have `_Wet.png`, `_Dry.png`, or `_Empty.png` suffixes
...
The trained model can be integrated back into GeoVue for automatic compartment prediction during compartment extraction. See the main CHANGELOG for ML pipeline integration notes.
