...
This script provides an easy way to train the wet/dry classifier
...
def quick_data_check(config: MLPipelineConfig) -> bool:
    ...
    try:
        ...
        if num_samples < 10:
            ...
            print("You need images named like: HoleID_CC_001_Wet.png or HoleID_CC_001_Dry.png")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="GeoVue ML Pipeline - Wet/Dry Classifier Training",
